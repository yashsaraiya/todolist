    ...
    return (
        ...
        <div className='bg-gray-900 min-h-[100vh]'>
            ...
            <div className="md:mx-auto md:container mx-3 my-5 rounded-xl p-5 bg-slate-700 min-h-[80vh]  md:w-1/2">
                ...
                <input type="checkbox" className="w-5 h-5 accent-yellow-500 cursor-pointer ml-12 text-center " checked={showfinish} onChange={togglefinish} name="" id="" /><span className="ml-3 font-rubikVinyl text-yellow-400 font-bold">Show finished</span>
                  </div>
                ...
                <div className="todos text-yellow-400 font-bold font-rubikVinyl">
                    ...
                    {todos.map(item => (
                       ...
                       (showfinish || !item.isComplated) && <div key={item.id} className="todo w-24 flex justify-between mt-7">
                            <input 
                                type="checkbox" 
